...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "neptunecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"81.94.192.39", "81.94.192.39"},
    {"88.150.205.162", "88.150.205.162"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. neptunecoin is probably already running."), addrBind.ToString().c_str());
        else
